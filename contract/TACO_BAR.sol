...
contract AVAX_Crops {
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e16; /** 0.1 AVAX  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 1000 * 1e18; /** 1000 AVAX  **/
    ...
    constructor(address _dev1, address _dev2, address _dev3, address _prtnr1, address _prtnr2, address _mkt, address _salsaInvestor) {
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        payable(prtnr1).transfer(tax);
        payable(prtnr2).transfer(tax);
