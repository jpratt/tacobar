const contract_address = "0x745Bb5BcE0d6E8FEcFf120E644D416009D88E7B5";
const contract_abi = [
  {
    inputs: [
      { internalType: "address", name: "_mkt", type: "address" },
      { internalType: "address", name: "_salsaInvestor", type: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "_addSalsaDeposit", type: "uint256" },
      { internalType: "uint256", name: "_claimedSalsa", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "addSalsaDeposit", type: "uint256" },
      { internalType: "uint256", name: "claimedSalsa", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
